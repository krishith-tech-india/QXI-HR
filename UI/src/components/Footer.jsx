      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted partner in HR solutions, providing comprehensive services for recruitment, 
              staffing, payroll management, and corporate training.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">Phone: +91 7778880721</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-4 h-4 text-blue-400 flex-shrink-0" />
                <span className="text-gray-400 text-sm">Telephone: 0281-2992804</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-4 h-4 text-blue-400 flex-shrink-0" />
                <span className="text-gray-400 text-sm">qxihroffice@gmail.com</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Stay connected with us for the latest updates and opportunities.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-center items-center">
          <p className="text-gray-400 text-sm text-center">
            © 2025 QXI HR (OPC) PRIVATE LIMITED. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
