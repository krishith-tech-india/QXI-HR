...
import { DollarSign, Users, Building, GraduationCap, CheckCircle, ArrowRight } from 'lucide-react';
...
const Services = () => {
  const services = [
    {
      title: 'HR Payroll',
      icon: DollarSign,
      description: 'Comprehensive payroll management solutions designed to streamline your payroll processes and ensure compliance.',
      features: [
  ...
  return (
    <>
      <Helmet>
        <title>Our Services - QXI HR Pvt Ltd</title>
        <meta name="description" content="Explore our comprehensive HR services including payroll management, placement services, staffing solutions, corporate training, and recruitment solutions." />
        <meta property="og:title" content="Our Services - QXI HR Pvt Ltd" />
        <meta property="og:description" content="Professional HR services tailored to your business needs including payroll, recruitment, staffing, and training solutions." />
      </Helmet>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto opacity-90">
              Comprehensive HR solutions designed to drive your business forward
            </p>
          </motion.div>
        </div>
      </section>
                ...
                >
                  ...
                  <div className={isEven ? 'lg:pl-8' : 'lg:pr-8 lg:col-start-1'}>
                    <div className="relative">
                      ...
                      <div className={`absolute -bottom-4 -right-4 w-20 h-20 rounded-full bg-gradient-to-r ${service.color} flex items-center justify-center shadow-lg`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our commitment to excellence and client satisfaction sets us apart in the HR consultancy industry.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: 'Expert Team',
                description: 'Our experienced professionals bring deep industry knowledge and proven expertise.',
                icon: '👥'
              },
              {
                title: 'Customized Solutions',
                description: 'Tailored HR solutions designed to meet your specific business requirements.',
                icon: '🎯'
              },
              {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto mb-8 opacity-90">
              Contact us today to discuss how our services can help transform your HR operations 
