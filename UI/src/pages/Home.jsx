...
const Home = () => {
    const slides = [
        {
            ...
            subtitle:
                "Strategic HR solutions to build, engage, and retain top talent.",
        },
        {
            ...
            subtitle:
                "Aligning HR strategies with your business objectives for sustainable success.",
        },
        {
            ...
            subtitle:
                "Comprehensive services from recruitment to payroll and corporate training.",
        },
    ];
    ...
    const services = [
        {
            title: "HR Payroll",
            description:
                "Comprehensive payroll management solutions for businesses of all sizes.",
            icon: "💼",
        },
        {
            title: "Placement Services",
            description:
                "Expert recruitment and placement services to find the right talent.",
            icon: "🎯",
        },
        {
        ...
        },
        {
            ...
            description:
                "Professional development and training programs for your team.",
            icon: "📚",
        },
    ];
    ...
    return (
        <>
            <Helmet>
                <title>
                    QXI HR (OPC) PRIVATE LIMITED - Professional HR Consultancy
                    Services
                </title>
                <meta
                    name="description"
                    content="QXI HR (OPC) PRIVATE LIMITED is a leading HR consultancy providing comprehensive solutions including payroll management, recruitment, staffing, and corporate training services."
                />
                <meta
                    property="og:title"
                    content="QXI HR (OPC) PRIVATE LIMITED - Professional HR Consultancy Services"
                />
                <meta
                    property="og:description"
                    content="Your trusted partner in HR solutions, providing comprehensive services for recruitment, staffing, payroll management, and corporate training."
                />
            </Helmet>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                QXI HR (OPC) PRIVATE LIMITED is a leading HR
                                consultancy firm dedicated to providing
                                comprehensive human resource solutions to
                                businesses across various industries. With over
                                15 years of experience, we have established
                                ourselves as a trusted partner for companies
                                seeking professional HR services.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Our team of experienced professionals
                                specializes in recruitment, staffing solutions,
                                payroll management, and corporate training,
                                helping organizations build strong, efficient,
            ...
            <section className="section-padding">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                            Comprehensive HR solutions tailored to meet your
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl max-w-3xl mx-auto opacity-90">
                            Let our experienced team help you build a stronger,
                            more efficient organization with our comprehensive
                            HR solutions.
                        </p>
