...
const Clients = () => {
  ...
  const fetchClients = async () => {
    ...
    try {
      const response = await fetch(API_ENDPOINTS.getClients, {
        ...
        body: JSON.stringify({ page: 1, pageSize: 100, isDescending: true })
      });
      ...
      toast({ title: 'Network Error', description: 'Could not load clients.', variant: 'destructive' });
    } finally {
      hideLoader();
    }
  };
  ...
  const handleAddClient = async () => {
    if (!logoFile) {
      toast({ title: 'Validation', description: 'Logo file is required.', variant: 'destructive' });
      return;
    }
    ...
    try {
      ...
      const uploadResp = await fetch(API_ENDPOINTS.getClientUploadUrl(logoFile.name), {
        headers: { Authorization: `Bearer ${token}` }
      });
      const uploadData = await uploadResp.json();
      if (!uploadData.isSuccess) throw new Error('Unable to get upload URL.');
      ...
      const createResp = await fetch(API_ENDPOINTS.createClient, {
        ...
        body: JSON.stringify({ name: clientName, logoUrl: uploadData.data.fileUrl })
      });
      ...
      if (createResult.isSuccess) {
        ...
        throw new Error(createResult.message || 'Failed to add client.');
      }
    } catch (err) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      if (result.isSuccess) {
        toast({ title: 'Removed', description: 'Client logo removed.' });
        fetchClients();
      } else {
  ...
  return (
    <>
      <Helmet>
        <title>Our Clients - QXI HR Pvt Ltd</title>
        <meta name="description" content="Discover the diverse range of clients we serve at QXI HR Pvt Ltd. From startups to Fortune 500 companies across various industries." />
        <meta property="og:title" content="Our Clients - QXI HR Pvt Ltd" />
        <meta property="og:description" content="Trusted by leading companies across technology, healthcare, finance, manufacturing, retail, and education sectors." />
      </Helmet>
      ...
      <section className="section-padding bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { number: '200+', label: 'Happy Clients', icon: Building },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We're proud to partner with companies of all sizes, from innovative startups to established enterprises.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {canManage && (
              <div className="bg-white rounded-xl shadow-lg p-4 flex flex-col gap-3 justify-between border border-dashed border-blue-200">
                <div>
                  <div className="font-semibold text-gray-800 mb-2">Add Client</div>
                  <Input
                ...
                <Button onClick={handleAddClient} disabled={isSubmitting} className="mt-2">
            ...
            {clients.map((client, index) => (
              ...
              >
                ...
                <img
                  src={client.logoUrl?.startsWith('http') ? client.logoUrl : `https://${client.logoUrl}`}
      ...
      <section className="section-padding bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our expertise spans across multiple industries, providing specialized HR solutions for each sector.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto mb-8 opacity-90">
              Let us help you achieve your HR goals and become our next success story.
            </p>
