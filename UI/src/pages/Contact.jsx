  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Our Office',
      details: ['Head Office – 804, 8Th Floor A-Wing RK Iconic Ayodhiya Chowk, 150 Feet Ring Rd, Rajkot, Gujarat 360007 (India)'],
      color: 'text-blue-600'
    },
    {
      icon: Phone,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with QXI HR (OPC) PRIVATE LIMITED. Contact our team for HR consultancy services, recruitment solutions, and professional support." />
        <meta property="og:title" content="Contact Us - QXI HR (OPC) PRIVATE LIMITED" />
        <meta property="og:description" content="Reach out to our experienced HR consultancy team. We're here to help with all your human resource needs." />
      </Helmet>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto opacity-90">
              Ready to transform your HR operations? Let's start the conversation.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We're here to help you with all your HR needs. Reach out to us through any of the following channels.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((info, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-16 h-16 mx-auto mb-4 ${info.color} bg-gray-100 rounded-full flex items-center justify-center`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div className="h-full min-h-[500px] relative">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.616781223605!2d70.7554988752934!3d22.292550179691866!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3959cbfd5f695b7b%3A0x1b2851d72d6205d1!2sRK%20Iconic!5e0!3m2!1sen!2sin!4v1731139443553!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto mb-8 opacity-90">
              Don't wait to transform your HR operations. Contact us today and let's discuss 
